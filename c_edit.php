...
<div class="container text-info">
   ...
   <form action="actions/c_edit.php"  method="post">
               <label>Name</label>
               ...
               <label>Type</label>
               <input class ="form-control" type ="text" name= "type" placeholder= "Type" value= "<?php echo $data['type'] ?>" />
               ...
               <input type= "hidden" name= "id" value= "<?php echo $data['places_id']?>" />
