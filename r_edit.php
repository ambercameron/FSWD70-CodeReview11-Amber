...
<div class="container text-info">
   ...
   <form action="actions/r_edit.php"  method="post">
               <label>Name</label>
               ...
               <input class ="form-control" type="text"  name="phone" placeholder ="Phone Number" value="<?php echo $data['phone'] ?>"  />
           
               <label>Cuisine</label>
               <input class ="form-control" type ="text" name= "cuisine" placeholder= "Cuisine" value= "<?php echo $data['cuisine'] ?>" />
